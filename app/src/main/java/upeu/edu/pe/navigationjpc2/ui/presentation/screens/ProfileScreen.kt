package upeu.edu.pe.navigationjpc2.ui.presentation.screens
...
import upeu.edu.pe.navigationjpc2.api.RetrofitClient
        ...
        RetrofitClient.apiService.getUsers().enqueue(object : Callback<List<User>> {
            override fun onResponse(call: Call<List<User>>, response: Response<List<User>>) {
                if (response.isSuccessful) {
                    ...
                    errorMessage = "Error en la respuesta delservidor"
                }
            }
